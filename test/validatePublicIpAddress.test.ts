...
import { validatePublicIpAddress } from "../src/validatePublicIpAddress";

describe("validatePublicIpAddress", function () {
    [
        "http://127.0.0.1:80",
        "http://127.0.0.1:443",
        "http://127.0.0.1:22",
        ...
        it(`should return an error for ${ipAddress}`, () => {
            assert.ok(validatePublicIpAddress(ipAddress) instanceof Error, "should return an error");
        });
    });
});
